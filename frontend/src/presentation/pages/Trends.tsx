  ...
  return (
    <div className="cr-page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
        ...
        {/* Trend graph */}
        <div className="lg:col-span-8 cr-card cr-card-pad flex flex-col justify-between">
          <div>
          ...
          <div className="flex gap-4 border-t border-slate-100 dark:border-cr-border-dark pt-3 mt-4 text-[10px] text-slate-405 font-bold flex-wrap">
        ...
        <div className="lg:col-span-4 cr-card cr-card-pad flex flex-col justify-between">
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between text-xs">
                <div className="flex items-center gap-2">
                  <span className="w-5 h-5 rounded bg-violet-100 dark:bg-violet-950 text-cr-accent dark:text-indigo-400 font-bold flex items-center justify-center text-[10px]">{idx + 1}</span>
                  <span className="text-slate-700 dark:text-cr-muted font-semibold">{item.name}</span>
                </div>
          ...
          <button className="w-full text-center text-xs text-cr-accent dark:text-indigo-400 font-bold hover:underline mt-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Tag Cloud */}
        <div className="lg:col-span-7 cr-card cr-card-pad">
          <h2 className="text-sm font-bold text-slate-800 dark:text-white mb-4">Exploración de temas</h2>
          <div className="flex flex-wrap gap-2">
            {[
              { text: 'docker compose', weight: 'text-sm bg-cr-accent text-white font-bold' },
              ...
              { text: 'nginx proxy manager', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-650 dark:text-cr-muted' },
              { text: 'vps', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'dokploy', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'next.js 15', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'postgresql', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'supabase', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'portainer', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'ia local', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'terraform', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'linux', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' },
              { text: 'devops', weight: 'text-xs bg-slate-100 dark:bg-cr-elevated-dark text-slate-600 dark:text-cr-muted' }
            ].map((tag, idx) => (
        ...
        <div className="lg:col-span-5 cr-card cr-card-pad flex flex-col justify-between">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={index} className="flex items-center justify-between text-xs py-2 border-b border-slate-100 dark:border-cr-border-dark/50">
                <span className="text-slate-700 dark:text-cr-muted font-semibold truncate pr-2">{item.title}</span>
